...
function tentukan_nilai ($nilai){
    if($nilai >=85 && $nilai<=100){
        ...
        echo $nilai." : Baik";
    } else if($nilai >=60 && $nilai<=67){
        echo $nilai." : Cukup";
    } else echo $nilai." : Kurang";
}
// Hapus komentar di bawah ini untuk jalankan code
